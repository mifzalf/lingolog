...
- Tab Latihan memakai grid ringkas 2×2 untuk empat game agar pilihan dapat dipindai tanpa kartu layar penuh. Latihan campuran menjadi satu aksi lebar setelah grid karena memiliki alur setup dua tahap: pilih bahan dan game, lalu atur filter game. Setup terakhir ditawarkan kembali melalui `AppDialog`, bukan langsung diterapkan tanpa persetujuan.
