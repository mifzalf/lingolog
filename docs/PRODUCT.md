...
- `Deck siap pakai` adalah koleksi materi gratis yang dibundel bersama aplikasi, bukan toko daring. Pengguna dapat membuka isi katalog, mencari/filter kata, frasa, atau kalimat, memilih satu atau banyak materi, lalu menentukan deck lokal tujuan yang pasangan bahasanya sama. Pilihan ini menjaga jumlah entri harian sesuai ritme belajar; penambahan seluruh deck tetap tersedia bagi pengguna yang menginginkannya. Setiap materi yang pasangan kata–artinya sudah ada pada deck lokal kompatibel diberi tanda dan nama lokasi deck agar pengguna tidak menyalinnya kembali tanpa sengaja.
- Katalog bawaan berfokus khusus pada Bahasa Jerman → Bahasa Indonesia dan berisi 43 deck kurasi A1–C1 dengan total 2.941 materi. Koleksi mencakup kata inti, frasa sehari-hari, waktu/cuaca/angka, perjalanan/akomodasi, profesi/kantor, masyarakat/debat, akademik, serta dua deck kalimat nyata yang terpisah. Materi ditulis satu per satu; tidak ada ekspansi template dengan mengganti nomina/verba.
...
- Game inti adalah **Kartu flash**, **Dikte**, **Jodohkan kata**, dan **Ingat Lagi**. Latihan campuran menjalankan dua atau lebih game terpilih dalam antrean acak dan berganti game setelah setiap satu pengerjaan, bukan setelah seluruh game dituntaskan. Filter bahan (deck, tanggal entri, mastery, jumlah, dan urutan) serta pengaturan lengkap tiap game disimpan lokal agar dapat digunakan kembali.
...
- Ingat Lagi menampilkan tiga item bernomor selama durasi terpilih. Pengguna dapat menampilkan kata, arti, atau arah acak per ronde. Setelah daftar disembunyikan, soal hanya menyebut nomor item dan meminta pasangannya; jawaban memakai maksimal empat pilihan unik serta stabil saat sesi dilanjutkan.
