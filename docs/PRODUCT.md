...
- Katalog bawaan berfokus khusus pada Bahasa Jerman → Bahasa Indonesia dan berisi 50 deck kurasi A1–C1 dengan total 2.941 materi. Koleksi mencakup kata inti, frasa sehari-hari, waktu/cuaca/angka, perjalanan/akomodasi, profesi/kantor, masyarakat/debat, akademik, serta dua deck kalimat nyata yang terpisah. Materi ditulis satu per satu; tidak ada ekspansi template dengan mengganti nomina/verba.
