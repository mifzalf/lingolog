...
- Migrasi SQLite fresh serta v1/v2/v3/v4/v5/v6/v7 ke v8, termasuk `application_id`, `integrity_check`, `foreign_key_check`, dan retensi data lama.
...
- [ ] Jodohkan kata menampilkan maksimal 5 pasangan per ronde; kedua kolom memiliki isi sama dalam urutan berbeda dan susunan tetap stabil setelah resume.
